...
export default function ServicesPage() {
  return (
    <main className="pt-24">
      <Helmet>
        <title>Our Services - EWaste Kochi | Certified ITAD & Recycling</title>
        <meta name="description" content="Explore our comprehensive e-waste services in Kochi including ITAD, data destruction, HDD shredding, and device buyback." />
      </Helmet>
