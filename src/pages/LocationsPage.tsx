...
export default function LocationsPage() {
  return (
    <main className="pt-24">
      <Helmet>
        <title>Service Locations - EWaste Kochi | Free Pickup Ernakulam</title>
        <meta name="description" content="Find e-waste drop-off locations and free pickup areas across Kochi, Kakkanad, Infopark, and all of Ernakulam." />
      </Helmet>
      ...
      <section className="py-24 bg-zinc-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {LOCATIONS.map((loc) => (
              <div key={loc} className="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm hover:shadow-md transition-shadow group">
